  ...
  <section className="container about-section">
    <div className="row">
      <div className="col-md-7 offset-md-3">
        ...
        <p>
          My name is Henry but some people call me Dru. I'm an Engineer based in
          Nairobi Kenya. The short story? I build things that work on computers
          and I enjoy it. I consider and intersection of people, product and
          innovation to be my Ikigai. Sounds hippie, I know.
        </p>
        <p>
        ...
        <p>
          ...
          consultancy to fintech and even a school. I loved every minute of it.
        </p>
        <p>
          ...
          language and is considering German and being a chef.
        </p>
      </div>
    </div>
  </section>
