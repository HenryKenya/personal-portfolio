    ...
    <div className="row">
      <div className="col-md-7 offset-md-3">
        ...
        <p>
          ...
          , a start-up that helps students find alternative accommodation.
        </p>
        <p>
          JavaScript, Kotlin, Swift and Java are my go-to tools of trade. I have
        ...
        <p>
          Over the years, aside from working as an engineer, I've also
          co-founded various companies spanning different industries from
          software consultancy to fintech and even a school. Every minute of it
          has been amazing.
        </p>
        <p>
